        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-3 mb-4">
          <div className="rounded-xl ring-1 ring-gray-200 bg-white p-4 flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-[11px] text-gray-500">ทั้งหมด {kpiData.totalAll}</div>
            </div>
          </div>
          <div className="rounded-xl ring-1 ring-gray-200 bg-white p-4 flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-[11px] text-gray-500">ทั้งหมด {kpiData.waitAll}</div>
            </div>
          </div>
          <div className="rounded-xl ring-1 ring-gray-200 bg-white p-4 flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-[11px] text-gray-500">ทั้งหมด {kpiData.doingAll}</div>
            </div>
          </div>
          <div className="rounded-xl ring-1 ring-gray-200 bg-white p-4 flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-[11px] text-gray-500">ทั้งหมด {kpiData.doneAll}</div>
            </div>
          </div>
          <div className="rounded-xl ring-1 ring-gray-200 bg-white p-4 flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-[11px] text-gray-500">ทั้งหมด {kpiData.remainAll}</div>
            </div>
          </div>
        </div>
