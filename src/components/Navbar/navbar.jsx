...
import logo from '/public/logo-ladluang.png';
...
const Navbar = () => {
    ...
    return (
        <header className={`${scrolled ? "bg-white/95 backdrop-blur-sm shadow-md" : "bg-white/95 backdrop-blur-sm"} border-b border-gray-200 sticky top-0 z-50 transition-all duration-300`}>
            ...
            <div className={`md:hidden border-t border-gray-200 ${mobileMenuOpen ? "border-b" : ""}`}>
                <div className="px-4 py-2 flex items-center gap-2">
                    <label className="relative flex-1">
                        <span className="sr-only">ค้นหา</span>
                        <input type="text" placeholder="ค้นหาข่าว/ประกาศ" className="w-full rounded-lg border border-gray-300 bg-white py-2 pl-10 pr-3 text-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500 shadow-sm transition-all duration-300" />
                    ...
                    <a href="./mock-report-home.html" className="rounded-lg bg-gradient-to-r from-primary-600 to-primary-700 px-3 py-2 text-sm font-medium text-white shadow-md transition-all duration-300">ร้องเรียน</a>
                    <a href="./mock-report-home.html" className="inline-flex items-center gap-2 rounded-lg bg-primary-600 px-3 py-2 text-sm font-medium text-white hover:bg-primary-700 focus:ring-2 focus:ring-primary-500 focus:ring-offset-2">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5"><path d="M12 3c-1.657 0-3 .895-3 2v1H6a3 3 0 0 0-3 3v6a3 3 0 0 0 3 3h3v1c0 1.105 1.343 2 3 2s3-.895 3-2v-1h3a3 3 0 0 0 3-3V9a3 3 0 0 0-3-3h-3V5c0-1.105-1.343-2-3-2z" /></svg>
                        แจ้งเรื่องร้องเรียน
                    </a>
                ...
                {mobileMenuOpen && (
                    <nav className="flex flex-col gap-2 px-4 pb-4 text-sm animate-fadeIn">
                        <a className="text-gray-700 hover:text-primary-700 py-2 border-b border-gray-100 transition-colors duration-300" href="#ข่าวสาร">ข่าวสาร</a>
                        <a className="text-gray-700 hover:text-primary-700 py-2 border-b border-gray-100 transition-colors duration-300" href="#ประกาศ">ประกาศ</a>
                        <a className="text-gray-700 hover:text-primary-700 py-2 border-b border-gray-100 transition-colors duration-300" href="#บริการประชาชน">บริการประชาชน</a>
                        <a className="text-gray-700 hover:text-primary-700 py-2 border-b border-gray-100 transition-colors duration-300" href="#ติดต่อ">ติดต่อเรา</a>
                        <a className="text-gray-700 hover:text-primary-700 py-2 transition-colors duration-300" href="./mock-login.html">เข้าสู่ระบบ</a>
                    </nav>
                )}
            </div>
        </header>
